...
# DELETE THESE & UN-COMMENT ABOVE LINES !!!
...
most_expensive_Veg2013 <- ggplot(top_10_expensive_Veg2013, aes(x = RetailPrice, y = reorder(Vegetable, RetailPrice))) +
  geom_bar(stat = "identity", position = "dodge", width = 0.7, fill = "skyblue") +
  labs(title = "Most Expensive Vegetabless 2013",
       x = "Retail Price (per equivalent cup, $)",
       y = "Vegetable") +
  theme_minimal()
...
least_expensive_Veg2013 <- ggplot(bottom_10_expensive_Veg2013, aes(x = RetailPrice, y = reorder(Vegetable, -RetailPrice))) +
  geom_bar(stat = "identity", position = "dodge", width = 0.7, fill = "lightgreen") +
  labs(title = "Least Expensive Vegetabless 2013",
       x = "Retail Price (per equivalent cup, $)",
       y = "Vegetable") +
  theme_minimal()
...
least_expensive_Veg2016 <- ggplot(top_10_expensive_Veg2016, aes(x = RetailPrice, y = reorder(Vegetable, RetailPrice))) +
  geom_bar(stat = "identity", position = "dodge", width = 0.7, fill = "skyblue") +
  labs(title = "Most Expensive Vegetabless 2016",
       x = "Retail Price (per equivalent cup, $)",
       y = "Vegetable") +
  theme_minimal()
...
least_expensive_Veg2016 <- ggplot(bottom_10_expensive_Veg2016, aes(x = RetailPrice, y = reorder(Vegetable, -RetailPrice))) +
  geom_bar(stat = "identity", position = "dodge", width = 0.7, fill = "lightgreen") +
  labs(title = "Least Expensive Vegetabless 2016",
       x = "Retail Price (per equivalent cup, $)",
       y = "Vegetable") +
  theme_minimal()
...
most_expensive_Veg2020 <- ggplot(top_10_expensive_Veg2020, aes(x = RetailPrice, y = reorder(Vegetable, RetailPrice))) +
  geom_bar(stat = "identity", position = "dodge", width = 0.7, fill = "skyblue") +
  labs(title = "Most Expensive Vegetabless 2020",
       x = "Retail Price (per equivalent cup, $)",
       y = "Vegetable") +
  theme_minimal()
...
least_expensive_Veg2020 <- ggplot(bottom_10_expensive_Veg2020, aes(x = RetailPrice, y = reorder(Vegetable, -RetailPrice))) +
  geom_bar(stat = "identity", position = "dodge", width = 0.7, fill = "lightgreen") +
  labs(title = "Least Expensive Vegetabless 2020",
       x = "Retail Price (per equivalent cup, $)",
       y = "Vegetable") +
  theme_minimal()
...
# Visualize Fruit 2013
barplot(table_fruits_form_2013, main = "Fruit Affordability by Form (2013)",
        xlab = "Form",
        ylab = "Count",
        col = c("skyblue", "coral"),
        beside = TRUE)
legend("topright", 
       legend = c("Affordable", "Not Affordable"),
       fill = c("skyblue", "coral"))

# Visualize Fruit 2016
barplot(table_fruits_form_Fruit2016, main = "Fruit Affordability by Form (2016)",
        xlab = "Form",
        ylab = "Count",
        col = c("skyblue", "coral"),
        beside = TRUE)
...
# Visualize Fruit 2020
barplot(table_fruits_form_Fruit2020, main = "Fruit Affordability by Form (2020)",
        xlab = "Form",
        ylab = "Count",
        col = c("skyblue", "coral"),
        beside = TRUE)
...
plot_2013 <- ggplot(df_2013, aes(x = Form, y = Count, fill = Affordability)) +
  ...
  scale_fill_manual(values = c("skyblue", "coral"),
                    labels = c("Afford", "Can't Afford")) + # Change legend labels
  theme_minimal()
