...
Using 'ggplot2' in R offered flexibility and customization for creating visually appealing plots. Its integration with the tidyverse package streamlined the analytics, allowing for seamless data manipulation and visualization. However, mastering its syntax and creating complex plots required time and effort. Despite potential challenges, 'ggplot2' provided a wide range of plot types and aesthetic options, making it a powerful tool for data visualization and analysis.

In order to collaborate on analyzing and visualizing our data in R as well as publicly share our analytical story, we created a public GitHub repository. The main victory of utilizing GitHub was that it provided a place where multiple people could work on the same project. We found it especially helpful to be able to share files from different programming languages and statistical softwares in one place. The main challenge was the learning curve associated with using GitHub for the first time. Another notable challenge that we faced was that only one person could make changes to the README.md file at a time. Overall, the Github repository made it very easy to collaborate and have access to the most updated version of our analysis files.
...
**Figure 3a-c.** Per capita income in 2013, 2016, and 2020.
...
The bar graph highlights a concerning trend regarding the affordability of meeting daily fruit and vegetable recommendations over time. This analysis is based on allocating 2% of per capita income by state for purchasing produce, with fruits and vegetables considered unaffordable if their yearly cup equivalent price exceeds this threshold, and affordable if it falls below. Regardless of the year, a significant disparity is evident in the proportion of individuals unable to afford the recommended daily servings of fruits and vegetables according to FDA guidelines. Moreover, there is a notable increase in the number of individuals facing affordability challenges in meeting their daily fruit and vegetable intake from 2013 to 2020.
...
To specifically investigate our driving question, we next examined the number of people across years who can and cannot afford the recommended daily serving of fruit and vegetables (for more information on how we calculated our affordability metric, see “Analytical Tools & Methods” section above). In 2013, 2016, and 2020, a significant disparity is evident in the proportion of individuals who are unable to afford the recommended daily servings of fruits and vegetables. Additionally, we found that the number of people struggling with the affordability of fruits and vegetables increased over the examined years. These striking findings highlight the pressing need for strategies to address the growing challenges individuals face in accessing nutritious foods over time. Finally, based on the findings that fruits and vegetables cover a wide array of prices and that a large number of people are unable to afford the recommended daily serving of fruits and vegetables, we planned an excursion analysis to investigate the difference in affordability across forms of fruits and vegetables. We found that fresh and canned fruits are less affordable than other forms of fruit, and fresh vegetables are less affordable than other forms of vegetables.

Furthermore, while our excursion analysis revealed disparities in affordability across different forms of fruits and vegetables, additional research is needed to examine the underlying drivers of these differences. Factors such as production methods, processing techniques, and market dynamics may contribute to variations in price and affordability. Additionally, future research could delve deeper into understanding the demographics of individuals who are most affected by the inability to afford fruits and vegetables, exploring factors such as income level, education, geographic location, and household composition. This knowledge could inform targeted interventions and policy decisions aimed at addressing disparities in access to nutritious foods and promoting health equity across diverse populations. In conclusion, our comprehensive analysis highlights the diverse pricing spectrum of fruits and vegetables, coupled with the concerning reality that a significant portion of the population struggles to afford the recommended daily servings. Our excursion analysis further elucidated disparities in affordability across different forms of fruits and vegetables, underscoring the need for efforts to address affordability barriers and promote equitable access to healthy food choices.
