...
| Data Sets                                                    |
|--------------------------------------------------------------|
| Annual person income by "Annual person income by county.csv" |
...
Income = read.csv("/Users/ashleysteinkrauss/Desktop/7900/GroupProj/Annual person income by county.csv") # Edit to match your directory path
```
...
## Further Analysis: Proportions of Affordability
